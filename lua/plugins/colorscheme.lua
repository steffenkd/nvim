...
--rebelot-kanagawa colorscheme with light and dark colorschemes; good one
--[[dd
...
--gruvbox-material colorscheme, "recommendeation" from Mischa van den Burg
...
-- catppuccin from theena from oviwrite
--[[
return 
{ "catppuccin/nvim"},
{
...
-- gruvbox, config from theena oviwrite
--[[
return
  { "ellisonleao/gruvbox.nvim" },
