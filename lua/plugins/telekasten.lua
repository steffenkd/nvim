...
function M.config()
 ...
 home = vim.fn.expand("/home/lucidebris/ipara/00-meshroom/"), -- Put the name of your notes directory here
...
-- if true, telekasten will be enabled when opening a note within the configured home
    ...
    dailies      = "/home/lucidebris/ipara/00-meshroom//00_diary",
    weeklies     = "/home/lucidebris/ipara/00-meshroom//0-blog",
    templates    = "/home/lucidebris/ipara/00-meshroom//templates",
...
--    image_subdir = "img",
    ...
    template_new_note = "/home/lucidebris/ipara/00-meshroom//templates/zettel_template.md",

   -- template for newly created daily notes (goto_today)
    -- set to `nil` or do not specify if you do not want a template
    template_new_daily = "/home/lucidebris/ipara/00-meshroom//00_diary/daily_template.md",

    -- template for newly created weekly notes (goto_thisweek)
    -- set to `nil` or do not specify if you do not want a template
    template_new_weekly= "/home/lucidebris/ipara/00-meshroom//0-blog/steffenkd-website-blog-template.md",
...
--only necessary on older config. Just requite in init.lua
--[[
--Base setup
